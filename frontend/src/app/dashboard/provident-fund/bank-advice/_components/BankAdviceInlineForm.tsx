...
export default function BankAdviceInlineForm({
  setOpen,
  refetchList,
  selectedItem,
  setSelectedItem,
             ...
             <CardContent className='form-dynamic-height overflow-y-auto px-6'>
                              ...
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Advice Type</FormLabel>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                 <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Advice Bank</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                      <FormControl>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                 <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Advice Slno</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                      <FormControl>
                                        <Input type='number' {...field} />
                                      </FormControl>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                  <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Advice Cdno</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                        <FormControl>
                                          <Input type='text' {...field} />
                                        </FormControl>
                          ...
                          <div className="mb-6 grid grid-cols-1 gap-6">
                              <FormField
                                ...
                                render={({ field }) => (
                                 <FormItem viewType='inline' className='flex items-center'>
                                    <FormLabel className='w-[15%]'>Advice Amount</FormLabel>
                                    <div className='flex w-[85%] flex-col'>
                                      <FormControl>
                                        <Input type='number' {...field} />
                                      </FormControl>
